<?php
   ...
   /**
    * Class ZohoCRMAddNoteResponseService
    * The service for working with ZohoCRM API user responses
    *
    * @package Grayl\Gateway\ZohoCRM
    */
   class ZohoCRMAddNoteResponseService implements ResponseServiceInterface
   {

      /**
       * Returns a true / false value based on a gateway API response
       *
       * @param ZohoCRMAddNoteResponseData $response_data The response object to check
       *
       * @return bool
       */
       ...
       *
       * @param ZohoCRMAddNoteResponseData $response_data The response object to pull the reference ID from
       *
       * @return string
       */
       ...
       *
       * @param ZohoCRMAddNoteResponseData $response_data The response object to get the message from
       *
       * @return string
       */
       ...
       *
       * @param ZohoCRMAddNoteResponseData $response_data The response object to get the data from
       *
       * @return array
       */
